...
export const dictionaries: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "editor.image": "Image",
    "editor.imageTooLarge": "This image is too large (max 4MB).",
    "editor.imageUploadNetworkError": "Couldn't reach the server — check your connection and try again.",
    "editor.imageUploadFailed": "Image upload failed. Please try again.",
  ...
  ko: {
    ...
    "editor.image": "이미지",
    "editor.imageTooLarge": "이미지 용량이 너무 큽니다 (최대 4MB).",
    "editor.imageUploadNetworkError": "서버에 연결할 수 없습니다 — 연결 상태를 확인한 뒤 다시 시도해 주세요.",
    "editor.imageUploadFailed": "이미지 업로드에 실패했습니다. 다시 시도해 주세요.",
    "editor.insertTable": "표 삽입",
    "editor.addRow": "행 추가",
    "editor.addColumn": "열 추가",
    "editor.deleteRow": "행 삭제",
    "editor.deleteColumn": "열 삭제",
    "editor.mergeCells": "셀 병합",
    "editor.splitCell": "셀 분할",
